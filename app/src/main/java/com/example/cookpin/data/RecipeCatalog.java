...
public final class RecipeCatalog {
    public static final class Recipe {
        ...
        public final int image, minutes;
        Recipe(String id, String title, String ingredients, String instructions, int image, int minutes) {
            this.id = id;
            this.title = title;
